...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "skills", "languages", "VIT", "interests", "personal-documents"],
            VIT: ["Year-1", "Year-2"],
            skills: ["Full-Stack Development", "LLM Applications", "RAG Pipelines", "Agentic AI", "Cloud Systems"],
            projects: ["VitCare", "CampusCare", "AskMyLecture"],
            interests: ["Football", "Space Exploration", "AI Research", "System Design"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">naif@Ubuntu</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/naif")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-naif, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
